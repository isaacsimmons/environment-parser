import { BOOL_TRUE_VALUES, validateBoolRaw, validateFloatParsed, validateFloatRaw, validateIntParsed, validateIntRaw } from './validators';
import { URL } from 'url';
...
export const parseBool: Parser<boolean> = s => {
  validateBoolRaw(s);
  return BOOL_TRUE_VALUES.includes(s);
};
