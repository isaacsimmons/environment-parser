...
export const myParseInt: Parser<number> = s => parseInt(s, 10);
export const myParseFloat: Parser<number> = parseFloat;
export const parseBigInt: Parser<BigInt> = s => BigInt(s);
export const parseBool: Parser<boolean> = s => TRUE_VALUES.includes(s);
